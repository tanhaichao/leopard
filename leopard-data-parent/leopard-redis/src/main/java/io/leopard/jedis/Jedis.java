...
public class Jedis extends redis.clients.jedis.Jedis {
	...
	public Jedis(String host) {
		this.jedis = DriverManager.wrapper(new redis.clients.jedis.Jedis(host));
	}

	public Jedis(String host, int port) {
		this.jedis = DriverManager.wrapper(new redis.clients.jedis.Jedis(host, port));
	}

	public Jedis(String host, int port, int timeout) {
		this.jedis = DriverManager.wrapper(new redis.clients.jedis.Jedis(host, port, timeout));
	}
